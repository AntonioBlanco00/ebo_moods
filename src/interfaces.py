...
class Requires:
    def __init__(self, ice_connector):
        ...
        self.EmergencyStop = self.create_proxy("EmergencyStopProxy", RoboCompEmergencyStop.EmergencyStopPrx)
...
class Implements:
    def __init__(self, ice_connector, default_handler):
        self.ice_connector = ice_connector
        self.ebomoods = self.create_adapter("EboMoods", ebomoodsI.EboMoodsI(default_handler))
